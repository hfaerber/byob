...
exports.up = function(knex) {
  return knex.schema
    ...
    .createTable('beers', table => {
      ...
      // table.foreign('brewery_existing_id').references('breweries.existing_id')
      table.foreign('brewery_existing_id').references('breweries.id')

      // how can I connect the existing ids that connect the two, to the primary key that is autogenerated??
